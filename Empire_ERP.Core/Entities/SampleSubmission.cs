...
namespace Empire_ERP.Core.Entities
{
    ...
    public class SampleSubmissionDetail
    {
        public int? TRAN_ID { get; set; }
        ...
        public string? ORIGINAL_SAMPLE_DOC { get; set; }
    ...
    public class CustomSampleSubmission
    {
        public SampleSubmission? Master { get; set; }
        public List<SampleSubmissionDetail>? Detail { get; set; }
    }

    public class SampleSubmissionRDLCReport
    {
        public int? TRAN_ID { get; set; }
    ...
    public class CustomSampleSubmissionForPrintReport
    {
        public SampleSubmissionRDLCReport? Master { get; set; }
