...
namespace Empire_ERP.Core.Entities
{
    ...
    public class VendorPricingDetail
    {
        public int? TRAN_ID { get; set; }
    ...
    public class CustomVendorPricing
    {
        public VendorPricing? Master { get; set; }
        public List<VendorPricingDetail>? Detail { get; set; }
    }

    public class VendorPricingRDLCReport
    {
        public int? TRAN_ID { get; set; }
    ...
    public class CustomVendorPricingForPrintReport
    {
        public VendorPricingRDLCReport? Master { get; set; }
