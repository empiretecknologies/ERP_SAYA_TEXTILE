...
namespace Empire_ERP.Core.Interfaces
{
    public interface IItemMasterService
    {
        ...
        MyHttpResponseMessage GetItemSizesInfoByCode(int code, Common common);
        ...
        MyHttpResponseMessage SaveItemSize(ItemAttribute itemAttribute, Common common);
        MyHttpResponseMessage GetBarcodeInfoByBarcodeId(int barCodeId, int code, Common common);
        MyHttpResponseMessage DeleteItemSizeInfo(int barCodeId, int code, Common common);
    }
}