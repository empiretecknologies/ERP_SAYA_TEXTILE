...
namespace Empire_ERP.Core.Interfaces
{
    public interface IMpoLayoutRepository
    {
        ...
        MyHttpResponseMessage GetDataForReport(MpoLayoutRDLCReport modelRecord, DataTable details, DataTable SubReportDetails, CustomMenuDetail menuDetails, Company currentCompany, Common common);
    }
}