...
{
    public interface ISampleDevAndPricingRepository_OLD
    {
        ...
        MyHttpResponseMessage GetDataForReport(SampleDevAndPricingReport modelRecord, CustomMenuDetail menuDetails, Company currentCompany, Common common);
    }
}
