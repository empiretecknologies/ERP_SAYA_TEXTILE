...
namespace Empire_ERP.Core.Services
{
    public class ItemMasterService : IItemMasterService
    {
        ...
        {
            return _itemMasterRepository.GetItemSizesInfoByCode(code, common);
        }
        ...
        public MyHttpResponseMessage SaveItemSize(ItemAttribute itemAttribute, Common common)
        {
            return _itemMasterRepository.SaveItemSize(itemAttribute, common);
        }
        ...
        {
            return _itemMasterRepository.DeleteItemSizeInfo(sizeId, sizeCode, common);
        }
    }
}