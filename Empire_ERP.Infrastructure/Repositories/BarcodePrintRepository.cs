                ...
                using (SqlConnection connection = new SqlConnection(new SQLService().getconnstring()))
                {
                    ...
                    while (reader.Read())
                    {
                        var row = new BarcodePrint
                        {
                            ...
                            ITEM_GROUP = reader["ITEM_GROUP"] == DBNull.Value ? "" : Convert.ToString(reader["ITEM_GROUP"]),
                            ...
                            COLOR_NAME = reader["COLOR_NAME"] == DBNull.Value ? "" : Convert.ToString(reader["COLOR_NAME"]),

                            SRATE = reader["SRATE"] == DBNull.Value ? 0.0 : Convert.ToDouble(reader["SRATE"]),
                            WSALE = reader["WSALE"] == DBNull.Value ? 0.0 : Convert.ToDouble(reader["WSALE"]),
                            RRATE = reader["RRATE"] == DBNull.Value ? 0.0 : Convert.ToDouble(reader["RRATE"]),
                            ...
                            ISRETAIL = false,
                            ISWHOLESALE = false,
                            BLABEL = reader["BLABEL"] == DBNull.Value ? 0 : Convert.ToInt32(reader["BLABEL"]),
                            CAT_CODE = reader["CAT_CODE"] == DBNull.Value ? "" : Convert.ToString(reader["CAT_CODE"]),
                            ITEM_ID = reader["ITEM_ID"] == DBNull.Value ? "" : Convert.ToString(reader["ITEM_ID"]),
