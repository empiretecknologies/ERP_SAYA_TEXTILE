...
{
    public class ItemMeasurementRepository : IItemMeasurementRepository
    {
        public IBranchRepository _branchRepository { get; set; }
        public ICommonRepository _commonRepository { get; set; }
        public IMenuRepository _menuRepository { get; set; }
        public ItemMeasurementRepository(IBranchRepository branchRepository, ICommonRepository commonRepository, IMenuRepository menuRepository)
        {
        ...
        public MyHttpResponseMessage Save(List<ItemMeasurement> modelRecord, Common common, Menu menu)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            try
            {
        ...
        public MyHttpResponseMessage GetItemMeasurementByCode(int code, Common common, Menu menu)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            try
            {
        ...
        public MyHttpResponseMessage GetItemMeasurementDetailsByCode(int code, Common common, Menu menu)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(new SQLService().getconnstring()))
                {
                    ...
                    while (reader.Read())
                    {
                        var row = new
                        {
                            ...
                            //WHT = reader["WHT"] == DBNull.Value ? 0 : Convert.ToDouble(reader["WHT"]),
        ...
        public MyHttpResponseMessage CopyRecord(CopyRecord record, Common common, Menu menu)
        {
            ...
            try
            {
                ...
                string connectionString = new SQLService().getconnstring();
                List<ItemMeasurement> ItemMeasurementList = new List<ItemMeasurement>();
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        ItemMeasurementList.Add(row);
                    }
                    reader.Close();
                    connection.Close();
                }
                response = this.Save(ItemMeasurementList, common, menu);
        ...
        public MyHttpResponseMessage DeleteItemMeasurementDetailByCode(int tranID, int code, Common common, Menu menu)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            try
            {
        ...
        public MyHttpResponseMessage GetDataForReport(ItemMeasurementRDLCReport modelRecord, DataTable dataTable, CustomMenuDetail menuDetails, Company currentCompany, Common common)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            ItemMeasurementRDLCReport masterData = new ItemMeasurementRDLCReport();
            CustomItemMeasurementForPrintReport reportData = new CustomItemMeasurementForPrintReport();
