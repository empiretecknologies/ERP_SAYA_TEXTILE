...
namespace Empire_ERP.Controllers
{
    ...
    public class CashReceiptVoucherController : BaseController
    {
        ...
        [HttpGet]
        public JsonResult GetPartyCurrentBalance(string partyCode, string actCode)
        {
            try
            {
                var common = CommonHelper.GetValues(HttpContext);
                ...
                var data = DropdownService.PartyCurrentBalance(StartDate, EndDate, partyCode, actCode, common, pType);
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult SaveDetailCharges(DetailCharges modelRecord)
        {
            try
            {
                var data = _cashReceiptVoucherService.SaveDetailCharges(modelRecord, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetDetailCharges(int tranId, int dtCode, int partyCode, int actCode)
        {
            try
            {
                var data = _cashReceiptVoucherService.GetDetailCharges(tranId, dtCode, partyCode, actCode, CommonHelper.GetValues(HttpContext));
        ...
        [HttpGet]
        public JsonResult GetSumDetailCharges(int tranId, int dtCode)
        {
            try
            {
                var data = _cashReceiptVoucherService.GetSumDetailCharges(tranId, dtCode, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult DeleteDetailCharges(DetailCharges model)
        {
            try
            {
                var data = _cashReceiptVoucherService.DeleteDetailCharges(model, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
