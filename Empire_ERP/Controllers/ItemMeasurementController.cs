...
namespace Empire_ERP.Controllers
{
    [CheckSession]
    [ExtractMenuCode]
    public class ItemMeasurementController : BaseController
    {
        public IItemMeasurementService _ItemMeasurementService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public IPeriodService _periodService { get; set; }
        public ItemMeasurementController(IMenuService menuService, IItemMeasurementService ItemMeasurementService, IWebHostEnvironment hostingEnvironment, IPeriodService periodService,IBaseService baseService) : base(menuService,baseService)
        {
            _ItemMeasurementService = ItemMeasurementService;
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Accounts = DropdownService.GetAccountsForCashReceiptVoucher(common.RoleID, common.RoleType);
            ...
            ViewBag.Currency = DropdownService.CurrencyDropdownWithControlName();
            ViewBag.DetailCharges = DropdownService.GetDetailCharges();
            return View();
        }
        ...
        [HttpGet]
        public JsonResult GetItemMeasurements()
        {
            try
            {
                var data = _ItemMeasurementService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult Save(List<ItemMeasurement> modelRecord)
        {
            try
            {
                var data = _ItemMeasurementService.Save(modelRecord, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetItemMeasurementByCode(int code)
        {
            try
            {
                var data = _ItemMeasurementService.GetItemMeasurementByCode(code, CommonHelper.GetValues(HttpContext));
                var detailData = _ItemMeasurementService.GetItemMeasurementDetailsByCode(code, CommonHelper.GetValues(HttpContext));
        ...
        [HttpGet]
        public JsonResult GetItemMeasurementDetailsByCode(int code)
        {
            try
            {
                var data = _ItemMeasurementService.GetItemMeasurementDetailsByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int code)
        {
            try
            {
                var data = _ItemMeasurementService.Delete(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult CopyRecord(CopyRecord record)
        {
            try
            {
                var data = _ItemMeasurementService.CopyRecord(record, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult DeleteItemMeasurementDetailByCode(int tranID, int code)
        {
            try
            {
                var data = _ItemMeasurementService.DeleteItemMeasurementDetailByCode(tranID, code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult GetPrintReport(ItemMeasurementRDLCReport model)
        {
        ...
        private string GenerateReport(ItemMeasurementRDLCReport model)
        {
            var filePath = "";
            try
            {
                if (model != null && model.TRAN_ID > 0 && model.MD_ID > 0)
                {
                    ...
                    var responseMessage = _ItemMeasurementService.GetDataForReport(model, reportDetails, CommonHelper.GetValues(HttpContext));
                    if (responseMessage.msgType != 1)
                    {
                        return "";
                    }
                    var reportData = (CustomItemMeasurementForPrintReport)responseMessage.data;
