                    ...
                    using (LocalReport report = new LocalReport())
                    {
                        ...
                        using (var stReader = new StreamReader(path))
                        {
                            ...
                            using (var stream = new MemoryStream(byteArray))
                            {
                                ...
                                ReportParameter parameter33 = new ReportParameter("OTHER_INCOME", Convert.ToString(reportData.OTHER_INCOME));
                                ReportParameter parameter34 = new ReportParameter("NET_AMT", Convert.ToString(reportData.NET_AMT));
                                ...
                                report.SetParameters(new ReportParameter[] { parameter, parameter1, parameter2, parameter3, parameter4, parameter5, parameter6, parameter7, parameter8,
                                    ...
                                    parameter22, parameter23, parameter24, parameter25, parameter26, parameter27, parameter28, parameter29, parameter30, parameter31, parameter32, parameter33, parameter34 });
