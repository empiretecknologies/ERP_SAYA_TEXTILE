...
namespace Empire_ERP.Controllers
{
    ...
    public class PurchaseBillController : BaseController
    {
        ...
        public PurchaseBillController(IPurchaseBillService purchaseBillService, IMenuService menuService, IWebHostEnvironment hostingEnvironment,IBaseService baseService) : base(menuService,baseService)
        {
                    ...
                    using (LocalReport report = new LocalReport())
                    {
                        ...
                        using (var stReader = new StreamReader(path))
                        {
                            ...
                            using (var stream = new MemoryStream(byteArray))
                            {
                                ...
                                if (model.MD_ID == 17 || model.MD_ID == 18)
                                {
                                    report.SetParameters(new ReportParameter[] { parameter, parameter1, parameter2, parameter3, parameter4, parameter24, parameter5, parameter6, parameter7, parameter8, parameter9, parameter10, parameter11, parameter12, parameter13, parameter14, parameter15, parameter16, parameter17, parameter18, parameter19, parameter20 });
                                    report.Refresh();
                                    report.DataSources.Add(new ReportDataSource() { Name = "PurchaseBillReportDataSet", Value = reportData.Detail });
                                }
