...
namespace Empire_ERP.Helpers
{
    public class ServiceRegistrationHelper
    {
        ...
        //public static void RegisterServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IQCJobAssignmentService, QCJobAssignmentService>();
            services.AddScoped<IQCJobAssignmentRepository, QCJobAssignmentRepository>();

            services.AddScoped<IInspectionProcessService, InspectionProcessService>();
            services.AddScoped<IInspectionProcessRepository, InspectionProcessRepository>();

            services.AddScoped<IPurchaseOrderReportsService, PurchaseOrderReportsService>();
            services.AddScoped<IPurchaseOrderReportsRepository, PurchaseOrderReportsRepository>();

            services.AddScoped<IYarnService, YarnService>();
            services.AddScoped<IYarnRepository, YarnRepository>();

            services.AddScoped<ISampleDevAndPricingService_OLD, SampleDevAndPricingService_OLD>();
            services.AddScoped<ISampleDevAndPricingRepository_OLD, SampleDevAndPricingRepository_OLD>();

            services.AddScoped<IVendorPricingService, VendorPricingService>();
            services.AddScoped<IVendorPricingRepository, VendorPricingRepository>();

            services.AddScoped<IPriceQuotedService, PriceQuotedService>();
            services.AddScoped<IPriceQuotedRepository, PriceQuotedRepository>();

            services.AddScoped<ISampleSubmissionService, SampleSubmissionService>();
            services.AddScoped<ISampleSubmissionRepository, SampleSubmissionRepository>();

            services.AddScoped<IItemMeasurementService, ItemMeasurementService>();
            services.AddScoped<IItemMeasurementRepository, ItemMeasurementRepository>();

            services.AddScoped<ISampleDevAndPricingService, SampleDevAndPricingService>();
            services.AddScoped<ISampleDevAndPricingRepository, SampleDevAndPricingRepository>();

            services.AddScoped<ISalesSamplingReportsService, SalesSamplingReportsService>();
            services.AddScoped<ISalesSamplingReportsRepository, SalesSamplingReportsRepository>();
        }
    }
}