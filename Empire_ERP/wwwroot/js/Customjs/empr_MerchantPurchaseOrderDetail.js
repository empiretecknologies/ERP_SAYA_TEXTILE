        ...
        var col = [
            ...
            },
            {
                ...
                setCellValue: function (newData, value, currentRowData) {
                    ...
                    var totaL_CARTON = parseFloat(currentRowData.totaL_CARTON) || 0;
                    newData.amt = value * rate;
                    if (totaL_CARTON > 0) {
                        newData.carton = value / totaL_CARTON;
                    } else {
                        newData.carton = 0;
                    }
                },
            ...
            },
            {
                ...
                alignment: 'center',
                setCellValue: function (newData, value, currentRowData) {
                    newData.totaL_CARTON = value;
                    var QTY = parseFloat(currentRowData.qty) || 0;
                    if (value > 0) {
                        newData.carton = QTY / value;
                    } else {
                        newData.carton = 0;
                    }
                },
