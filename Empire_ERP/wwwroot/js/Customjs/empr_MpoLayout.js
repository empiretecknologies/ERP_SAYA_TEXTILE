var empr_MpoLayout = {
            ...
            },
            {
                ...
                cellTemplate: function (container, options) {
                    ...
                    const crossBtn = $('<a>')
                        ...
                        .on('click', function () {
                            options.data.caD_FILE_DOC = null;
                            txtFileName.val('');
                        });
            ...
            },
            {
                ...
                cellTemplate: function (container, options) {
                    ...
                    const crossBtn = $('<a>')
                        ...
                        .append($('<i>').addClass('fa fa-times'))
                        .on('click', function () {
                            options.data.laY_SUBD_DOC = null;
                            txtFileName.val('');
                        });
            ...
            },
            {
                ...
                cellTemplate: function (container, options) {
                    ...
                    const crossBtn = $('<a>')
                        ...
                        .append($('<i>').addClass('fa fa-times'))
                        .on('click', function () {
                            options.data.stofF_SUBD_DOC = null;
                            txtFileName.val('');
                        });
    ...
    CreateQuickSearchGrid: function (dataSrc) {
        ...
        { dataField: 'remarks', caption: 'Design #', alignment: 'center' },
    ...
    ValidateInfo: function () {
        ...
        if (data.Master.JOB_NO == '' || data.Master.JOB_NO == null || data.Master.JOB_NO == undefined || data.Master.JOB_NO == 0) {
        ...
        $.each(data.Detail, function (index, item) {
            ...
            if (item.carD_FILE_DATE == "" || item.carD_FILE_DATE == null || item.carD_FILE_DATE == undefined) {
                empr_helper.notify("Please select CAD File Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // CAD File Doc
            if (item.caD_FILE_DOC == "" || item.caD_FILE_DOC == null || item.caD_FILE_DOC == undefined) {
                empr_helper.notify("Please upload CAD File Doc at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // Layout Subm Date
            if (item.laY_SUBM_DATE == "" || item.laY_SUBM_DATE == null || item.laY_SUBM_DATE == undefined) {
                empr_helper.notify("Please select Layout Subm Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // Layout Subd Date
            if (item.laY_SUBD_DATE == "" || item.laY_SUBD_DATE == null || item.laY_SUBD_DATE == undefined) {
                empr_helper.notify("Please select Layout Subd Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }

            // Layout Submitted Doc
            if (item.laY_SUBD_DOC == "" || item.laY_SUBD_DOC == null || item.laY_SUBD_DOC == undefined) {
                empr_helper.notify("Please upload Layout Submitted Doc at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // Layout Appr Date
            if (item.laY_APPR_DATE == "" || item.laY_APPR_DATE == null || item.laY_APPR_DATE == undefined) {
                empr_helper.notify("Please select Layout Appr Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // StrikeOff Subm Date
            if (item.stofF_SUBM_DATE == "" || item.stofF_SUBM_DATE == null || item.stofF_SUBM_DATE == undefined) {
                empr_helper.notify("Please select StrikeOff Subm Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // StrikeOff Subd Date
            if (item.stofF_SUBD_DATE == "" || item.stofF_SUBD_DATE == null || item.stofF_SUBD_DATE == undefined) {
                empr_helper.notify("Please select StrikeOff Subd Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }

            // StrikeOff Submitted Doc
            if (item.stofF_SUBD_DOC == "" || item.stofF_SUBD_DOC == null || item.stofF_SUBD_DOC == undefined) {
                empr_helper.notify("Please upload StrikeOff Submitted Doc at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
            ...
            // StrikeOff Appr Date
            if (item.stofF_APPR_DATE == "" || item.stofF_APPR_DATE == null || item.stofF_APPR_DATE == undefined) {
                empr_helper.notify("Please select StrikeOff Appr Date at Line no " + (index + 1), 2);
                valid = false;
                return valid;
            }
        });
