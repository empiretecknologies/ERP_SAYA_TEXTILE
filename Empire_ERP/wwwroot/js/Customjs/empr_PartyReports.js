var empr_PartyReports = {
    ...
    InitEvents: function () {
        ...
        empr_PartyReports.InitCurrencyDDL();
    ...
    GetDataToSave: function () {
        ...
        var PASS = $("#PASS").val();
        var isCurrency = $('#CURRENCY').prop('checked') ? 1 : 0;
    ...
    InitReportGrid: function (dataSrc, reportId) {
        ...
        if (reportId == 58) {
            ...
            col = [
                ...
                { dataField: 'chqNo', caption: 'Ref No', width: 100 },
                { dataField: 'chqDate', caption: 'Ref Date', dataType: 'date', format: 'dd/MM/yyyy', width: 100 },
        ...
        setTimeout(function () {
            if (reportId === 99 ||reportId === 10 || reportId === 11 || reportId === 98 || reportId === 97 || reportId === 98 || reportId === 102 || reportId === 52 || reportId === 51)
