var empr_Yarn = {
    initEvents: function () {
        ...
        $(document).ready(function () {
            ...
            $('#BtnSave').click(function () {
                if (Permissions != "Admin") {
                    if (!$("#Code").val() && !Permissions.r_ADD) {
                        ...
                        if (empr_Yarn.validateForm()) {
                            empr_Yarn.saveAttempt();
                        }
                    }
                } else {
                    if (empr_Yarn.validateForm()) {
            ...
            $('body').on('click', '.elm_edit', function () {
                ...
                empr_Yarn.GetSetupSubTypeByID(reportid);
            });
    ...
    saveAttempt: function () {
        ...
        var obj = empr_Yarn.GetDataToSave();
